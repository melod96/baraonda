...
public class Notice {
	...
	public Notice(int board_no, int board_type, int writing_type, String board_title, String board_content,
			int member_no, Date board_date, Date modify_date, int board_status, int board_count, String profile,
			String files_change_title) {
		super();
	...
	public String toString() {
		return "Notice [board_no=" + board_no + ", board_type=" + board_type + ", writing_type=" + writing_type
				...
				+ ", board_count=" + board_count + ", profile=" + profile + ", files_change_title=" + files_change_title
				+ "]";
	}
