...
public class NoticeMarking implements Serializable{
	...
	public NoticeMarking() {
		
	}

	public NoticeMarking(int marking_no, int marking_type, Date marking_date, int board_no, int member_no) {
		super();
	...
	public String toString() {
		return "NoticeMarking [marking_no=" + marking_no + ", marking_type=" + marking_type + ", marking_date="
