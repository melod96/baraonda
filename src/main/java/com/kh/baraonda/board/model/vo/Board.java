...
public class Board {
	...
	public Board(int board_no, int board_type, int writing_type, String board_title, String board_content,
			int member_no, Date board_date, Date modify_date, int board_status, int board_count, int files_no,
			int f_reference_no, String files_title, String files_change_title, int files_type, String files_root,
			int files_secession, String profile_root, String profile) {
		super();
	...
	public String toString() {
		return "Board [board_no=" + board_no + ", board_type=" + board_type + ", writing_type=" + writing_type
				...
				+ ", board_count=" + board_count + ", files_no=" + files_no + ", f_reference_no=" + f_reference_no
				+ ", files_title=" + files_title + ", files_change_title=" + files_change_title + ", files_type="
				+ files_type + ", files_root=" + files_root + ", files_secession=" + files_secession + ", profile_root="
