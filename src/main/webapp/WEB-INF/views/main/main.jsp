	...
	<!-- 처방 서비스 -->
     ...
     <!--  <div class="gallery">
       ...
       <div class="grid_4">
        <div class="gall_block">
          <div class="maxheight">
            <a href="${pageContext.request.contextPath}/resources/images/bbig1.jpg" class="gall_item"><img src="${pageContext.request.contextPath}/resources/images/page2_img1.jpg" alt=""></a>
            <div class="gall_bot">
      ...
      <div class="grid_4">
        <div class="gall_block">
          <div class="maxheight">
            <a href="${pageContext.request.contextPath}/resources/images/big3.jpg" class="gall_item"><img src="${pageContext.request.contextPath}/resources/images/page2_img2.jpg" alt=""></a>
            <div class="gall_bot">
            <div class="text1"><a href="#">수지 다이어트 컬럼 </a></div>
	         <label>2018-10-23</label>&nbsp;|&nbsp;조회수&nbsp;<label style="color:red">0</label>&nbsp;|&nbsp;좋아요&nbsp;<label style="color:red">6</label>
	         <br>
      ...
      <div class="grid_4">
        <div class="gall_block">
          <div class="maxheight">
            <a href="${pageContext.request.contextPath}/resources/images/bbig3.jpg" class="gall_item"><img src="${pageContext.request.contextPath}/resources/images/page2_img3.jpg" alt=""></a>
            <div class="gall_bot">
           <div class="text1"><a href="#">수지 다이어트 컬럼 </a></div>
	         <label>2018-10-23</label>&nbsp;|&nbsp;조회수&nbsp;<label style="color:red">0</label>&nbsp;|&nbsp;좋아요&nbsp;<label style="color:red">6</label>
	         <br>
      ...
      <div class="grid_4">
        <div class="gall_block">
          <div class="maxheight">
            <a href="${pageContext.request.contextPath}/resources/images/bbig4.jpg" class="gall_item"><img src="${pageContext.request.contextPath}/resources/images/page2_img4.jpg" alt=""></a>
            <div class="gall_bot">
           <div class="text1"><a href="#">수지 다이어트 컬럼 </a></div>
	         <label>2018-10-23</label>&nbsp;|&nbsp;조회수&nbsp;<label style="color:red">0</label>&nbsp;|&nbsp;좋아요&nbsp;<label style="color:red">6</label>
	         <br>
      ...
      <div class="grid_4">
        <div class="gall_block">
          <div class="maxheight">
            <a href="${pageContext.request.contextPath}/resources/images/bbig5.jpg" class="gall_item"><img src="${pageContext.request.contextPath}/resources/images/page2_img5.jpg" alt=""></a>
            <div class="gall_bot">
            <div class="text1"><a href="#">수지 다이어트 컬럼 </a></div>
	         <label>2018-10-23</label>&nbsp;|&nbsp;조회수&nbsp;<label style="color:red">0</label>&nbsp;|&nbsp;좋아요&nbsp;<label style="color:red">6</label>
	         <br>
      ...
      <div class="grid_4">
        <div class="gall_block">
          <div class="maxheight">
            <a href="${pageContext.request.contextPath}/resources/images/bbig6.jpg" class="gall_item"><img src="${pageContext.request.contextPath}/resources/images/page2_img6.jpg" alt=""></a>
            <div class="gall_bot">
           <div class="text1"><a href="#">수지 다이어트 컬럼 </a></div>
	         <label>2018-10-23</label>&nbsp;|&nbsp;조회수&nbsp;<label style="color:red">0</label>&nbsp;|&nbsp;좋아요&nbsp;<label style="color:red">6</label>
	         <br>
