...
<body>
    ...
    function paginate(num){
    	if(${ search != null }){
    		location.href="goBlackMemberAdminList.adm?currentPage=" + num + "&searchContent=${ search.content }";
    	}else{
    		location.href="goBlackMemberAdminList.adm?currentPage=" + num;
    	}
    }
    </script>
