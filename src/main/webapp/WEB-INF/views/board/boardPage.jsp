		...
		<div class="container">
			<div class="row">
				...
				<div class="container">
					...
					<!-- 게시글 제목 -->
					<div>
						<span style="font-size: 17px; font-weight: bold;">오늘부터 운동
							시작합니다!</span>
					</div>
					<hr class="hrline">
					<div class="boardInfo">
					...
					<div class="btn_ar">
						<a href="#"> <img style="margin-right: 12px;"
...
댓글에 대한 신고가 접수될 경우, 내용에 따라 즉시 삭제될 수 있습니다."
					...
					<div class="balist1">
						...
						<div class="aflist3">
							<p style="display: inline-block;">17:30</p>
							<img
								src="<%=request.getContextPath()%>/resources/images/boardImg/bar_9.gif"
								class="listpic">
							<p style="display: inline-block;">조회수 10</p>
						</div>
					</div>
					<!-- 이전글 제목, 날짜, 조회수 -->
					<div>
						...
						<div class="belist3">
							<p style="display: inline-block;">13:30</p>
							<img
								src="<%=request.getContextPath()%>/resources/images/boardImg/bar_9.gif"
								class="listpic">
							<p style="display: inline-block;">조회수 32</p>
						</div>
					</div>
				</div>
				<!-------------------------------------------------------------------------->
